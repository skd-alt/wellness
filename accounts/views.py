...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, 'To complete the process an activation link has been sent to your email.')
...
def login(request):
    if request.method == 'POST':
        ...
        #             # get cart for user to accesse product vars
        #             cart_item = CartItem.objects.filter(user=user)
        #             # existing variations check
        #             ex_var_list = []
        #             id = []
        #             for item in cart_item:
        ...
        #         # gets next=/cart/checkout
        #         params = dict(x.split('=') for x in query.split('&'))
        #         # splits into dict with next as key and /cart/checkout as value
        #         if 'next' in params:
